...
def main():
	...
	parser.add_argument('--processed-log', default=os.path.join(log_dir, 'processed_files.log'), help='Log file for processed files')
	parser.add_argument('--failed-updates-log', default=os.path.join(log_dir, 'failed_updates.log'), help='Log file for failed metadata updates')
	...
	parser.add_argument('--duplicates-log', default=os.path.join(log_dir, 'duplicates.log'), help='Log file for duplicates')
